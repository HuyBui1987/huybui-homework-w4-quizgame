var questions = [
    {
        title: 'How to write a comment on a single line?',
        choices: ['// my comment //', '// my comment', '/* my comment */', 'ALL of the above'],
    ...
    {
        title: 'Which of the following functions display “Hello, World!” on the screen in console mode?',
        choices: ['echo("Hello, World!");', 'print("Hello, World!");', 'printf("Hello, World!");', 'show("Hello, World!");'],
...
//timer run when user start the quiz
function startTimer() {
    ...
    var timeInterval = setInterval(function () {
        ...
        timer.textContent = "Time Left : " + secondsLeft + " sec";
...
function viewResult() {
    ...
    //Create form for storing highscore
    var form = document.createElement("form");      

    var label = document.createElement("label");    
    label.textContent = "Enter Name : ";

    //textbox for inputting user name
...
function storeScores(event) {
    ...
    console.log(user);
     ...
     //get User highscores array in localStorage if exists
...
function showHighScores() {
    ...
    //PreviousScores array length stored in localStorage
    var userLength = 0;
    if (previousScores) {
